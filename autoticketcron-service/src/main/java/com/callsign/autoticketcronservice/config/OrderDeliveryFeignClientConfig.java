 ...
 * @date 4/17/2022
 */
public class OrderDeliveryFeignClientConfig {
    ...
    // Only accessible withing OrderDeliveryFeignClientConfig and not for other Spring context
    @Bean
    ...
    private String requestJWT() {
        return loginFeignClient.login(serviceConfig.getOrderSrvApiUsername(), serviceConfig.getOrderSrvApiPassword());
    }
}
